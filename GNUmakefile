...
#
SUBDIRS := bnbpi0 #ADD_NEW_SUBDIR ... do not remove this comment from this line
...
doxygen:
	...
	@mkdir -p $(LARLITE_USERDEVDIR)/BNB_NC/doc/dOxygenMyProject
	@doxygen $(LARLITE_USERDEVDIR)/BNB_NC/doc/doxygenMyProject.script
